            ...
            <div className="relative z-10 max-w-7xl mx-auto space-y-16">
                ...
                <div className="text-center space-y-4">
                    ...
                    <h2 className={clsx("text-4xl md:text-5xl font-black text-white", lang === 'ta' && 'font-tamil')}>
                        {lang === 'en' ? 'Relive the Glory' : 'α«╡α»Çα«░ α«╡α«┐α«│α»êα«»α«╛α«ƒα»ìα«ƒα»ü α«¿α«┐α«⌐α»êα«╡α»üα«òα«│α»ì'}
                    </h2>
                    <p className={clsx("text-xl text-zinc-400 max-w-2xl mx-auto", lang === 'ta' && 'font-tamil')}>
                        {lang === 'en'
                            ...
                            : 'α«ñα«┐α«░α»üα«¿α«▓α»ìα«▓α»éα«░α»ì α«£α«▓α»ìα«▓α«┐α«òα»ìα«òα«ƒα»ìα«ƒα«┐α«⌐α»ì α«òα«ƒα«¿α»ìα«ñ α«òα«╛α«▓ α«Üα«┐α«▓α«┐α«░α»ìα«¬α»ìα«¬α«╛α«⌐ α«ñα«░α»üα«úα«Öα»ìα«òα«│α»ê α«òα«╛α«úα»üα«Öα»ìα«òα«│α»ì.'}
                    </p>
                </div>
                                    ...
                                    >
                                        ...
                                        <div className="absolute bottom-0 left-0 right-0 p-4 z-20">
                                            ...
                                            <div className="mt-2 flex items-center gap-2 text-xs text-zinc-400 font-medium uppercase tracking-wider group-hover:text-white transition-colors">
                                                <span>{lang === 'en' ? 'Watch Now' : 'α«òα«╛α«úα»èα«│α«┐α«»α»ê α«òα«╛α«ú'}</span>
                                                <Play size={12} />
                                            </div>
                                        </div>
                                    </motion.a>
